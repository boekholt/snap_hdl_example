...
# Add FPGA binaries
COPY JARVICENAE-0A0A1841_noSDRAM_N250S_21.tar.gz /etc/NAE/CAPI.tar.gz
COPY JARVICENAE-0A0A1841_noSDRAM_N250S_21.signature.sha256 /etc/NAE/CAPI.signature.sha256
